...
export const CLIENTS = [
  ...
  { id: 7, nom: 'Jean-Luc Mobutu',       type: 'Athlète',     ville: 'Kinshasa',    email: 'jl.mobutu@gmail.com',        tel: '+243 998 220 114', adresse: 'Centre Académique de Kinshasa, RDC',                     ca: 75000, docs: 3 },
  { id: 8, nom: 'Yaya Diallo',           type: 'Athlète',     ville: 'Kinshasa',    email: 'y.diallo@kinshasafc.cd',     tel: '+243 990 551 207', adresse: 'Kinshasa FC — Centre d’entraînement, RDC',               ca: 120000, docs: 2 },
];
...
export const ATHLETES = {
  7: {
    club: 'AS V.Club (Kinshasa)', poste: 'Milieu offensif', pied: 'Droit', age: 21,
  ...
  8: {
    club: 'Kinshasa FC', poste: 'Attaquant', pied: 'Gauche', age: 19,
...
export const CAMPS = [
  { id: 'CMP-01', nom: 'Camp Élite U17', lieu: 'Lubumbashi', dateDebut: '2026-07-01', dateFin: '2026-07-14', categorie: 'U17', places: 40, inscrits: 33, statut: 'En cours', clientId: 4 },
  { id: 'CMP-02', nom: 'Stage gardiens de but', lieu: 'Kinshasa', dateDebut: '2026-08-05', dateFin: '2026-08-12', categorie: 'Spécifique', places: 18, inscrits: 11, statut: 'Inscriptions', clientId: null },
  { id: 'CMP-03', nom: 'Camp de présaison — clubs partenaires', lieu: 'Matadi', dateDebut: '2026-09-02', dateFin: '2026-09-16', categorie: 'Senior', places: 30, inscrits: 0, statut: 'Planifié', clientId: 5 },
];
